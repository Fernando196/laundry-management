...
const yesterdayOrders = computed(() => orders.filter((o) => o.createdAt.startsWith(yesterdayStr)))
...
const activeMachines = computed(
  () => machines.filter((m) => m.status.type === 'running' || m.status.type === 'active').length,
)
...
<template>
  <div class="w-full h-full overflow-auto">
    <div class="mx-auto max-w-screen-xl p-6 space-y-6">
