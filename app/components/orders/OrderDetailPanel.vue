  ...
  <div class="flex h-full flex-col bg-white">
    ...
    <div class="border-b border-neutral-100 px-6 py-5">
      <div class="flex items-start justify-between gap-3">
        ...
        <span class="mt-1 rounded-full px-3 py-1 text-xs font-semibold" :class="statusMap[order.status].class">
    ...
    <div class="flex-1 overflow-auto px-6 py-5 space-y-6">
      ...
      <section>
        ...
        <div class="flex items-center gap-3">
          <div
            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary-light text-sm font-bold text-primary">
      ...
      <section class="rounded-xl border border-neutral-100 bg-neutral-50 px-4 py-4">
        <div class="flex items-center justify-between">
          ...
          <span class="text-2xl font-bold text-neutral-900">${{ order.amount }} <span
              class="text-sm font-normal text-neutral-400">MXN</span></span>
        </div>
      </section>
    </div>
