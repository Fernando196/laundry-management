...
<template>
  <button
    class="flex w-full cursor-pointer items-center gap-3 border-b border-neutral-100 px-4 py-3 text-left transition-colors last:border-b-0"
  ...
  >
    ...
    <span
      ...
      :class="statusMap[order.status].dot"
    />
    ...
    <div class="min-w-0 flex-1">
      ...
      <div class="mt-0.5 flex items-center gap-2">
        <span
          ...
          :class="statusMap[order.status].chip"
        >
